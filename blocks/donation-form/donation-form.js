    ...
    submitOwnerInformationForm.addEventListener("click", (e) => {
      ...
      initDonationForm(
        ...
        (success) => {
          ...
          thankYouDiv.textContent = "Thank you for your donation! 🙏";
          thankYouDiv.style = "font-size:1.5rem; color:green; margin-top:2rem;";
          block.append(thankYouDiv);
        },
        (error) => {
          console.error("❌ Donation failed:", error);
          sessionStorage.clear();
          const errorDiv = document.createElement("div");
          errorDiv.textContent = "Payment failed. Please try again or contact support.";
          errorDiv.style = "font-size:1.5rem; color:red; margin-top:2rem;";
