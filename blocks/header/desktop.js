...
export function headerDesktop(block, fragment, scrollThreshold, darkLogo, lightLogo, containerListMenu) {
    ...
    desktopContainer.className = 'hidden lg:flex h-24 z-20 px-4 fixed transition-colors duration-300 w-full justify-between items-center gap-2 px-4 xl:px-16';
...
function setupLogoVisibility(darkLogo, lightLogo, container, scrollThreshold) {
    ...
    hyperLink.appendChild(darkLogo)
    hyperLink.appendChild(lightLogo)
